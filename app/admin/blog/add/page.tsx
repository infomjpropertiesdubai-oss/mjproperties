  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || 'Failed to create blog post. Please try again.')
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-mj-teal via-mj-teal-light to-mj-dark text-mj-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-mj-gold mb-2">Add New Blog Post</h1>
        ...
        <Card className="bg-mj-teal-light/80 border-mj-gold/20 backdrop-blur-sm shadow-lg">
          <CardHeader>
            ...
            <CardDescription className="text-mj-white/80">
              Fill in all the details for the new blog post
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  {isSubmitting ? (
                    <>
                      ...
                      {(selectedFeaturedFile || selectedAuthorFile) ? 'Uploading Images & Creating Blog...' : 'Creating Blog Post...'}
                    </>
                  ) : (
                    <>
